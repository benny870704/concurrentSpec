...
class TestFeature(unittest.TestCase):
    ...
    def test_generate_folder_with_feature_name(self):
        ...
        self.assertTrue(os.path.exists(f"{self.test_path}/steps/google_search/"))
        self.assertEqual(1, len(os.listdir(f"{self.test_path}/steps/google_search/")))
        self.assertTrue(os.path.exists(f"{self.test_path}/steps/google_search/simple_google_search.py"))
    ...
    def test_feature_is_duplicated(self):
        ...
        self.assertEqual("Declare more than one feature in a file is not allowed.", str(e.exception))
    ...
    def test_generate_folder_without_feature_name(self):
        ...
        self.assertTrue(os.path.exists(f"{self.test_path}/steps/feature/"))
        self.assertEqual(1, len(os.listdir(f"{self.test_path}/steps/feature/")))
        self.assertTrue(os.path.exists(f"{self.test_path}/steps/feature/simple_google_search.py"))

    def test_generate_folder_with_feature_name_without_scenario(self):
        Feature(feature_name="Google search", feature_description="Use Google to search everything")
        
        self.assertFalse(os.path.exists(f"{self.test_path}/steps/google_search/"))
    ...
    def test_generate_folder_with_feature_name_and_add_scenario_without_scenario_name(self):
        ...
        self.assertTrue(os.path.exists(f"{self.test_path}/steps/google_search/"))
        self.assertEqual(1, len(os.listdir(f"{self.test_path}/steps/google_search/")))
        self.assertTrue(os.path.exists(f"{self.test_path}/steps/google_search/step_definitions.py"))
    ...
    def test_generate_folder_without_feature_name_and_add_scenario_without_scenario_name(self):
        ...
        self.assertTrue(os.path.exists(f"{self.test_path}/steps/feature/"))
        self.assertEqual(1, len(os.listdir(f"{self.test_path}/steps/feature/")))
        self.assertTrue(os.path.exists(f"{self.test_path}/steps/feature/step_definitions.py"))
